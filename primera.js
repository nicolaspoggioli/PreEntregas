...
let remitente = prompt ("Indique su zona de residencia (caba, oeste, norte o sur").toLowerCase();
...
{alert ("ingrese un dato valido, escoga entre caba, norte, oeste y sur"); calcularEnvio()}
}
